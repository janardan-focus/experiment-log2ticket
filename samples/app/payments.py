...
appears in a traceback, so it is the test case for whether sanitizing actually
...
# Deliberately bad practice — this is the sanitizing test fixture.
...
def charge(order_id: str, amount_cents: int) -> dict[str, Any]:
    ...
    # model. This is the sanitizing test.
